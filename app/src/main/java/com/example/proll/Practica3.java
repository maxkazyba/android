...
public class Practica3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent games = new Intent(Practica3.this, Games.class);
        Intent proglang = new Intent(Practica3.this, Proglang.class);
        Intent cars = new Intent(Practica3.this, Cars.class);
    ...
    public void OnRecyclerview(View view){
        Intent recv = new Intent(Practica3.this, Recyclerview3pr.class);
        startActivity(recv);
    }
